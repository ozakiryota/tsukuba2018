...
void LongPathDetection::detection_main(void)
{
	...
	farthest_point.point.x = longest_path_length*cos(longest_path_length_angle); 
	farthest_point.point.y = longest_path_length*sin(longest_path_length_angle); 
	farthest_point.point.z = 0.0;
}
